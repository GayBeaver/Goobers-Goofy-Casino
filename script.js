...
const state = {
    ...
    casino: {
        buildings: {
            busker: { name: 'Street Busker', amount: 0, baseCost: 15, baseIncome: 1, costGrowth: 1.15 },
            slots: { name: 'Slot Machine', amount: 0, baseCost: 100, baseIncome: 8, costGrowth: 1.15 },
            blackjack: { name: 'Blackjack Table', amount: 0, baseCost: 750, baseIncome: 55, costGrowth: 1.15 },
            roulette: { name: 'Roulette Table', amount: 0, baseCost: 5000, baseIncome: 320, costGrowth: 1.15 },
            vip: { name: 'VIP Lounge', amount: 0, baseCost: 35000, baseIncome: 1800, costGrowth: 1.15 },
            highRoller: { name: 'High Roller Suite', amount: 0, baseCost: 250000, baseIncome: 11000, costGrowth: 1.15 },
            corporate: { name: 'Corporate Endorsement', amount: 0, baseCost: 2000000, baseIncome: 75000, costGrowth: 1.15 },
            empire: { name: 'Casino Empire', amount: 0, baseCost: 20000000, baseIncome: 550000, costGrowth: 1.15 }
        }
    },
